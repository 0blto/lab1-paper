...
<p>По сути SSR можно написать на любом серверном языке (Java, Pytho, PHP и т.д.), как это и происходило раньше. Ведь принцип довольно простой. Однако сама реализация достаточно трудоемка, что привело к появлению современных фреймворков с небольшим порогом вхождения.</p>
