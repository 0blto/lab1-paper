...
- META теги
  - Убедитесь, что каждая страница вашего приложения имеет уникальные мета-теги <pre language="html"><title>, <meta name="description"></pre>, и другие мета-теги, которые могут быть важны для SEO.
- 
