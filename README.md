...
> То есть по мимо небольшого HTML файла браузер получает зачастую очень большой app.js, что негативно скажется на владельцев маломощных устройств или устройств со слабым интернет-соединением так как им придется достаточно долго ждать загрузку. Помимо этого приложение смогут увидеть пользователи с отключенным или неподдерживаемым JavaScript в браузере. 
