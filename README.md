...
<p>Структура Next.js приложения такая же как и у приложения на React.js. Можно писать те же клиентские компоненты и стили, однако добавляется особенность работы со страницами и серверной частью приложения.</p>
